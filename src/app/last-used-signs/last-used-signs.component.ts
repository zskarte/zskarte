...
@Component({
  selector: 'app-last-used-signs',
  templateUrl: './last-used-signs.component.html',
  styleUrls: ['./last-used-signs.component.css'],
})
export class LastUsedSignComponent implements OnInit {
  constructor(
  ...
  addSign(sign: Sign) {
    ...
    if (index !== -1) {
      ...
      this.signsSource.splice(9, this.signsSource.length - (this.signsMaxLength - 1));
    }
