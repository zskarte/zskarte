...
CREATE TABLE "accesses" (
	...
	CONSTRAINT "accesses_document_id_unique" UNIQUE("document_id"),
...
CREATE TABLE "files" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "files_document_id_unique" UNIQUE("document_id")
);
--> statement-breakpoint
CREATE TABLE "journal_entries" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "journal_entries_document_id_unique" UNIQUE("document_id"),
...
CREATE TABLE "map_layer_generation_config" (
	...
	"style_swiss_boundaries_3d_id" integer,
	...
	"style_swiss_names_3d_id" integer,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "map_layer_generation_config_document_id_unique" UNIQUE("document_id")
);
--> statement-breakpoint
CREATE TABLE "map_layers" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "map_layers_document_id_unique" UNIQUE("document_id")
);
--> statement-breakpoint
...
CREATE TABLE "map_snapshots" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "map_snapshots_document_id_unique" UNIQUE("document_id")
);
--> statement-breakpoint
CREATE TABLE "operations" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "operations_document_id_unique" UNIQUE("document_id")
);
--> statement-breakpoint
...
CREATE TABLE "signing_keys" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "signing_keys_document_id_unique" UNIQUE("document_id"),
	CONSTRAINT "signing_keys_key_id_unique" UNIQUE("key_id")
);
--> statement-breakpoint
CREATE TABLE "organization_wms_sources" (
	"organization_id" integer NOT NULL,
	"wms_source_id" integer NOT NULL,
...
CREATE TABLE "wms_sources" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "wms_sources_document_id_unique" UNIQUE("document_id")
);
--> statement-breakpoint
ALTER TABLE "accesses" ADD CONSTRAINT "accesses_operation_id_operations_id_fk" FOREIGN KEY ("operation_id") REFERENCES "public"."operations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "accesses" ADD CONSTRAINT "accesses_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "journal_entries" ADD CONSTRAINT "journal_entries_operation_id_operations_id_fk" FOREIGN KEY ("operation_id") REFERENCES "public"."operations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "map_layer_generation_config" ADD CONSTRAINT "map_layer_generation_config_style_entrances_id_files_id_fk" FOREIGN KEY ("style_entrances_id") REFERENCES "public"."files"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "map_layer_generation_config" ADD CONSTRAINT "map_layer_generation_config_style_swiss_boundaries_3d_id_files_id_fk" FOREIGN KEY ("style_swiss_boundaries_3d_id") REFERENCES "public"."files"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "map_layer_generation_config" ADD CONSTRAINT "map_layer_generation_config_style_swiss_names_3d_id_files_id_fk" FOREIGN KEY ("style_swiss_names_3d_id") REFERENCES "public"."files"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "map_layers" ADD CONSTRAINT "map_layers_wms_source_id_wms_sources_id_fk" FOREIGN KEY ("wms_source_id") REFERENCES "public"."wms_sources"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "map_layers" ADD CONSTRAINT "map_layers_media_source_id_files_id_fk" FOREIGN KEY ("media_source_id") REFERENCES "public"."files"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "map_layers" ADD CONSTRAINT "map_layers_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_map_layer_favorites" ADD CONSTRAINT "organization_map_layer_favorites_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_map_layer_favorites" ADD CONSTRAINT "organization_map_layer_favorites_map_layer_id_map_layers_id_fk" FOREIGN KEY ("map_layer_id") REFERENCES "public"."map_layers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "map_snapshots" ADD CONSTRAINT "map_snapshots_operation_id_operations_id_fk" FOREIGN KEY ("operation_id") REFERENCES "public"."operations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "organizations" ADD CONSTRAINT "organizations_logo_id_files_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."files"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_wms_sources" ADD CONSTRAINT "organization_wms_sources_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_wms_sources" ADD CONSTRAINT "organization_wms_sources_wms_source_id_wms_sources_id_fk" FOREIGN KEY ("wms_source_id") REFERENCES "public"."wms_sources"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "wms_sources" ADD CONSTRAINT "wms_sources_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
