...
export const ROLE_PERMISSIONS: Record<Role, ReadonlySet<PermissionKey>> = {
  organization: permissions(
    ...
    'operation.patch', 'operation.publishCurrentLocation', 'operation.shadowDelete', 'operation.submitChangeset',
  ...
  guest: permissions(
    ...
    'journal.byId', 'journal.byNumber', 'journal.create', 'journal.list', 'journal.update',
    'mapLayer.byId', 'mapLayer.list', 'mapSnapshot.byId', 'mapSnapshot.list',
    'operation.archive', 'operation.byId', 'operation.create', 'operation.list', 'operation.overview',
    'operation.patch', 'operation.publishCurrentLocation', 'operation.shadowDelete', 'operation.unarchive',
  ...
  operationwrite: permissions(
    ...
    'operation.patch', 'operation.publishCurrentLocation', 'operation.submitChangeset', 'operation.updateMapLayers',
