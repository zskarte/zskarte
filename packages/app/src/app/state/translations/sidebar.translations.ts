//the layer and filter sidebar text are in layer.translation.ts
//the selected feature sidebar texts are in map.translations.ts
export const SIDEBAR_TRANSLATIONS = {
  ...
  noShareLinks: {
    ...
    fr: "Aucun lien n'est disponible pour cette opération.",
  },
