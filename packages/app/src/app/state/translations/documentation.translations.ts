/**
 * ========================================
 * 📚 DOCUMENTATION & HELP TRANSLATIONS
 * ========================================
 * 
 * This module contains translation keys specifically for help text, user guidance,
 * documentation, and educational content in the ZSKarte disaster management application.
 * 
 ...
 *    - Feature introductions and overviews
 *    - FAQ-style content and explanations
 * 
 * ✅ Educational Content:
 ...
 *    - Functional UI labels (buttons, form fields, menus)
 *    - Journal-specific workflow terms
 *    - Map interface controls and tools
 *    - Error messages or validation text
 * 
 * 📝 ADDING NEW KEYS:
 * When adding documentation-related translations, follow this format:
 * 
 * yourHelpKey: {
 *   de: 'German help text',
 ...
 * },
 * 
 * Current size: ~640 lines covering comprehensive help documentation and user guidance.
 * ========================================
 */
