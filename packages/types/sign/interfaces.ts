...
export function defineDefaultValuesForSignature(signature: Sign) {
  ...
  iconsOffset.endHasDifferentOffset =
  ...
  signature.hazardCode = signature.hazardCode ?? signatureDefaultValues.hazardCode;
  signature.unNumber = signature.unNumber ?? signatureDefaultValues.unNumber;
}
